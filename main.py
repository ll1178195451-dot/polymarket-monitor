...
def main():
    print("XRP SOL 5分钟和15分钟 买入监控 已启动 (阈值 50 shares 测试模式)")
            ...
            for mins in [5, 15]:
                ...
                for trade in trades:
                    ...
                    if side == "BUY" and size >= THRESHOLD and wallet:
                        ...
                        alert = "买入大单警报 | 市场: " + name + " | 时间段: " + time_period + " | 方向: " + direction + " | 买入数量: " + str(int(size)) + " shares | 钱包: " + wallet[:8] + "..." + wallet[-6:]
