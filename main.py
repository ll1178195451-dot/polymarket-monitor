...
def main():
    print("XRP SOL 监控已启动 (单笔买入 或 总持仓 ≥ 700 shares，均价过滤 0.03~0.97)")
        ...
        for asset in ["xrp", "sol"]:
            for mins in [5, 15]:
                ...
                for trade in trades:
                    ...
                    # 均价过滤：只提醒 0.03 < price < 0.97 的单子
                    if side == "BUY" and size >= THRESHOLD and wallet and 0.03 < price < 0.97:
